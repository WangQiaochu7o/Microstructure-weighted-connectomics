...
class AnalysisConfig:
    ...
    def __init__(self):
        ...
        self.output_path = "/home/localadmin/Desktop/SP2/164output/group_averaged_output/single"
...
def create_aggregated_silhouette_sweep_plot(all_sweep_data, all_optimal_data, output_dir):
    ...
    ax.set_title('Silhouette Score vs. Number of Clusters (Nearest Neighbor Method, Destrieux Atlas)', fontsize=16, fontweight='bold')
    ...
    output_file = os.path.join(output_dir, "hierarchical_silhouette_sweep_aggregated_164regions_with_binary.png")
...
def main():
    ...
    print("="*80)
    print("Hierarchical Clustering Analysis - single Method (164-region Destrieux)")
    print("="*80)
    ...
    for metric in config.metrics:
        ...
        if results and results['success']:
            ...
            output_assignment_file = os.path.join(
                config.output_path, 
                f"hierarchical_optimal_assignments_{metric}_164regions.csv"
            )
