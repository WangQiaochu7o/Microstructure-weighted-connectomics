...
class AnalysisConfig:
    ...
    def __init__(self):
        ...
        self.output_path = "/home/localadmin/Desktop/SP2/84output/group_averaged_output/mixed"
...
def create_aggregated_silhouette_sweep_plot(all_sweep_data, all_optimal_data, output_dir):
    ...
    ax.set_title('Silhouette Score vs. Number of Clusters (Desikan-Killiany Atlas)', fontsize=16, fontweight='bold')
...
def main():
    ...
    print("Hierarchical Clustering Analysis - Dynamic Method (84-region Desikan-Killiany)")
    print("="*80)
